    ...
    >
      ...
      <section className="max-w-3xl px-5 py-10 mx-auto my-10 text-center bg-white rounded-lg bg-opacity-80">
        <h2 className="text-2xl font-semibold text-red-500">
          Why Choose History and Culture?
        </h2>
        <p className="mt-4 text-gray-600">
          History and Culture courses dive into the rich heritage and societal
          developments of civilizations across the globe. Learn about diverse
          programs, research opportunities, and entrance exams for leading
      ...
      <section className="px-5 py-10">
        <h2 className="mb-8 text-2xl font-semibold text-center text-gray-900">
          Relevant History and Culture Courses and Entrance Exams
        </h2>
        <div className="grid max-w-5xl grid-cols-1 gap-6 mx-auto md:grid-cols-2">
          <div className="p-5 text-center bg-white rounded-lg shadow-md bg-opacity-90">
            ...
            <p className="mt-3 text-gray-600">
              An undergraduate program focusing on historical events, cultural
              studies, and the evolution of societies.
            </p>
            <details className="mt-3">
              ...
              <p>
                <strong>JNU Entrance:</strong> Jawaharlal Nehru University Test
          ...
          <div className="p-5 text-center bg-white rounded-lg shadow-md bg-opacity-90">
            ...
            <p className="mt-3 text-gray-600">
              A postgraduate course that explores historical theories, cultural
              heritage, and detailed study of historical eras.
            </p>
            <details className="mt-3">
              <summary className="text-red-500 cursor-pointer">
                View Entrance Exams
          ...
          <div className="p-5 text-center bg-white rounded-lg shadow-md bg-opacity-90">
            ...
            <p className="mt-3 text-gray-600">
              An introductory program covering cultural analysis, heritage
              management, and the impact of culture on society.
            </p>
            <details className="mt-3">
              <summary className="text-red-500 cursor-pointer">
                View Entrance Exams
              ...
              <p className="mt-2">
                <strong>IGNOU Entrance Test:</strong> Entrance for Cultural
                Studies - Tentative Date: July
              </p>
            </details>
          </div>
          ...
          <div className="p-5 text-center bg-white rounded-lg shadow-md bg-opacity-90">
            ...
            <p className="mt-3 text-gray-600">
              An advanced research program focused on historical analysis,
              cultural preservation, and academic contributions.
            </p>
            <details className="mt-3">
              <summary className="text-red-500 cursor-pointer">
                View Entrance Exams
              ...
              <p className="mt-2">
                ...
                Humanities - Tentative Date: December
              </p>
            </details>
          </div>
        </div>
