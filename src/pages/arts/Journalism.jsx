    ...
    >
      ...
      <section className="max-w-3xl px-5 py-10 mx-auto my-10 text-center bg-white rounded-lg bg-opacity-80">
        ...
        <p className="mt-4 text-gray-600">
          Journalism courses provide the skills needed for a dynamic career in
          news, media, and communication. Discover diverse programs, from
          reporting and media studies to digital journalism, along with entrance
          exams for top institutes.
        </p>
      </section>
      ...
      <section className="px-5 py-10">
        <h2 className="mb-8 text-2xl font-semibold text-center text-gray-900">
          Relevant Journalism Courses and Entrance Exams
        </h2>
        <div className="grid max-w-5xl grid-cols-1 gap-6 mx-auto md:grid-cols-2">
          <div className="p-5 text-center bg-white rounded-lg shadow-md bg-opacity-90">
            ...
            <p className="mt-3 text-gray-600">
              An undergraduate program covering news reporting, media ethics,
          ...
          <div className="p-5 text-center bg-white rounded-lg shadow-md bg-opacity-90">
            <h3 className="text-xl font-semibold text-red-500">
              Master of Arts in Journalism (MA Journalism)
            </h3>
            <p className="mt-3 text-gray-600">
              A postgraduate course focused on advanced reporting, media law,
              and digital journalism techniques.
            </p>
            <details className="mt-3">
              <summary className="text-red-500 cursor-pointer">
                View Entrance Exams
          ...
          <div className="p-5 text-center bg-white rounded-lg shadow-md bg-opacity-90">
            ...
            <p className="mt-3 text-gray-600">
              An introductory program covering online reporting, social media
            ...
            <details className="mt-3">
              ...
              <p className="mt-2">
                ...
                Journalism - Tentative Date: July
              </p>
            </details>
          </div>
          ...
          <div className="p-5 text-center bg-white rounded-lg shadow-md bg-opacity-90">
            ...
            <p className="mt-3 text-gray-600">
              An advanced research program exploring media theory, communication
              studies, and journalism ethics.
            </p>
            <details className="mt-3">
              <summary className="text-red-500 cursor-pointer">
                View Entrance Exams
              ...
              <p className="mt-2">
                <strong>UGC NET:</strong> National Eligibility Test for Media
